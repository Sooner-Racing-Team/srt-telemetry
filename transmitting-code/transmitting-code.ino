...
// SCL needs to be in pin 21
// SDA needs to be in pin 20
...
//  Serial.print(a.acceleration.x); // Print raw values
//  Serial.println(" Gs");
  // Serial.print('\t');
  /*Serial.print(", Y: ");
  ...
  */
  ...
  Serial.print(a_avg_x); // Filtered average
  Serial.println(" Gs");
...
double transmit(double accel, double millimeters, double temp) {
  ...
  Serial.print("transmit is being entered");
